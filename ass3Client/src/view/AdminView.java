...
import model.models.AdminModel;
...
public class AdminView extends JFrame {
	...
	public AdminView(AdminModel adminModel) {
		...
		rdbtnSecretary.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				userType = "secretary";
			}
		});
		buttonGroup.add(rdbtnSecretary);
		rdbtnSecretary.setBounds(106, 445, 73, 23);
		contentPane.add(rdbtnSecretary);
		rdbtnSecretary.setActionCommand("secretary");
		...
		rdbtnDoctor.setBounds(181, 445, 73, 23);
